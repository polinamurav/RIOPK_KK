...
import * as clients from '@app/store/reducers/clients.reducers';
import * as clientsFilter from '@app/store/reducers/clients-filter.reducers';
...
import * as massSegmentDirectories from '@app/store/reducers/mass-segment-directories.reducers';
...
export const appReducers: ActionReducerMap<IAppState, any> = {
  ...
  clientsFilter: clientsFilter.clientsFilterReducer,
  ...
  massSegmentDirectories: massSegmentDirectories.reducer,
