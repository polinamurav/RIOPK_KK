...
@Component({
  ...
  styleUrls: ['./comparison-panel-modal.component.scss', '../../../../shared/modals/close-modal-btn.scss']
})
export class ComparisonPanelModalComponent implements OnInit, OnDestroy {
  ...
  selectedItem(item: ApplicationByPinDto) {
    ...
    const url = this.router.createUrlTree(['/mode/lending/queues/stages/view', item.id]).toString();
