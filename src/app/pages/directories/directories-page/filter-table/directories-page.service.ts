...
export class FilterTableService {
  ...
  getSelect(params: string): Observable<PageDTO<TypeDto>> {
    const selectOptions = {
      ...
      'inspection-result': () => {
        return this.setInspectionResultData();
      },
      'preapproved-factor': () => {
      ...
      'inn-type': () => {
        return this.setInnTypeData();
      },
      'inn-status': () => {
        return this.setInnStatusData();
      },
      'dir-goods': () => {
        return this.setDirGoodsData();
      },
      'ensure-type': () => {
    ...
    if (selectOptions.hasOwnProperty(params)) {
      ...
      this.router.navigate(['/mode/lending/directories/declines']);
    }
  }
  ...
  private setPaymentCardData(): Observable<PageDTO<Dir>> {
    this.tableBlockWidth = null;
    this.fileName = 'FilesNames.PaymentCards';
  ...
  private setInspectionResultData(): Observable<PageDTO<DirBusinessInspectionResult>> {
    this.tableBlockWidth = null;
    this.fileName = 'Результат выезда на место бизнеса.xlsx';
    this.service = this.dirBusinessInspectionResultService;
    this.objColNameProps = HEADERS.INSPECTION_RESULT;
    this.setAction = DirectoriesActions.DirSetInspectionResultAction;
    this.uploadAction = DirectoriesActions.DirUploadInspectionResultAction;
    return this.selectInspectionResult$;
  }
  ...
  private setInnTypeData(): Observable<PageDTO<Dir>> {
    this.tableBlockWidth = null;
    this.fileName = 'Тип клиента по ИНН.xlsx';
    this.service = this.dirInnTypeService;
    this.objColNameProps = HEADERS.INN_TYPE;
    this.setAction = DirectoriesActions.DirSetInnTypeAction;
    this.uploadAction = DirectoriesActions.DirUploadInnTypeAction;
    return this.selectInnType$;
  }

  private setInnStatusData(): Observable<PageDTO<Dir>> {
    this.tableBlockWidth = null;
    this.fileName = 'Статус ИНН.xlsx';
    this.service = this.dirInnStatusService;
    this.objColNameProps = HEADERS.INN_STATUS;
    this.setAction = DirectoriesActions.DirSetInnStatusAction;
    this.uploadAction = DirectoriesActions.DirUploadInnStatusAction;
    return this.selectInnStatus$;
  }

  private setDirGoodsData(): Observable<PageDTO<Dir>> {
    this.tableBlockWidth = null;
    this.fileName = 'Категория товара.xlsx';
    this.service = this.dirGoodsService;
    this.objColNameProps = HEADERS.DIR_GOODS;
    this.setAction = DirectoriesActions.DirSetDirGoodsAction;
    this.uploadAction = DirectoriesActions.DirUploadDirGoodsAction;
    return this.selectDirGoods$;
  }
