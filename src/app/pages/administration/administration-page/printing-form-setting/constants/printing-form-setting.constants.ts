...
export const PRINTING_FORM_SETTING_HEADERS: TableDataHeader[] = [
  ...
  new TableDataHeader('stage.nameGe', 'Administration.TableHeaders.Stage', 'ge', 'stage.nameGE'),
  ...
  new TableDataHeader('printingForm.nameGe', 'Administration.TableHeaders.PrintingForm', 'ge', 'printingForm.nameGe'),
