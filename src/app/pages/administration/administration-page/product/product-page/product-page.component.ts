...
type Options = ProductRes | Dir | DirProductGroup | DirAbsCode;
...
export class ProductPageComponent implements OnInit, OnDestroy {
  ...
  dataSource: TableData<ProductRes>;
  objColNameProps: TableDataHeader[] = PRODUCT_HEADERS;

  private newProductData: ProductResDto = new EmptyProductResDto();
  private selectProduct$: Observable<PageDTO<ProductRes>> = this._store.pipe(select(selectProduct));
  ...
  selectedItem(product: ProductRes) {
  ...
  openNewProductDialog() {
    this.showDialog(
      ...
      (productBeforeRequest: ProductResDto) => {
        this._store.dispatch(
          AdmCreateProductAction({
            paginationData: this.params,
            data: {
