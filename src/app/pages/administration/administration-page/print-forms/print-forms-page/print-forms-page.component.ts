...
export class PrintFormsPageComponent implements OnInit, OnDestroy {
  objColNameProps: TableDataHeader[] = [
    ...
    new TableDataHeader('nameRu', 'НАИМЕНОВАНИЕ', 'string'),
    new TableDataHeader('icon_upload', 'ЗАГРУЗИТЬ', 'iconButton'),
    new TableDataHeader('icon_download', 'ВЫГРУЗИТЬ', 'iconButton')
  ];
