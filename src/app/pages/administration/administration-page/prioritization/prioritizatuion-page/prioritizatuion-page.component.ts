...
import { TableDataHeader, TableData, Directory, PageDTO, PaginationAndSortingDto, ProductRes } from '@app/_models';
...
export class PrioritizatuionPageComponent implements OnInit, OnDestroy {
  ...
  productData: TableData<ProductRes>;
  ...
  selectedProductItem(item: ProductRes) {}
