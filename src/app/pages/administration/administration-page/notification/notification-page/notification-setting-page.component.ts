...
import { NotificationSettingModalComponent } from '@app/shared/modals/notification-modal/notification-setting-modal.component';
...
export class NotificationSettingPageComponent implements OnInit, OnDestroy {
  ...
  objColNameProps: TableDataHeader[] = [
    ...
    new TableDataHeader('valueGe', 'Administration.TableHeaders.Notifications.ValueGe', 'string', 'valueGe'),
