...
export const BLACKLIST_HEADERS: TableDataHeader[] = [
  new TableDataHeader('blacklistItemValue', 'Administration.TableHeaders.BlackList.BlacklistItemValue', 'string', 'blacklistItemValue'),
  new TableDataHeader('active', 'Administration.TableHeaders.BlackList.Active', 'status', 'active'),
  new TableDataHeader('blacklistComment', 'Administration.TableHeaders.BlackList.BlacklistComment', 'string', 'blacklistComment'),
  ...
  new TableDataHeader('changedByUsername', 'Administration.TableHeaders.BlackList.ChangedByUsername', 'string', 'changedByUsername'),
  new TableDataHeader('blacklistItem.nameRu', 'Administration.TableHeaders.BlackList.BlacklistItem', 'ru', 'blacklistItem.nameRu'),
  new TableDataHeader('blacklistItem.nameGe', 'Administration.TableHeaders.BlackList.BlacklistItem', 'ge', 'blacklistItem.nameGe')
];
