...
export class BlacklistPageComponent implements OnInit, OnDestroy {
  totalCount: number;
  ...
  setOptionsList(): void {
    forkJoin([
      this.blacklistItemService.getAll()
    ])
  ...
  private showDialog(
    data: AdministrationBaseModalData<BlacklistDto, Options>,
    callback: (val: BlacklistDto) => void
  ) {
