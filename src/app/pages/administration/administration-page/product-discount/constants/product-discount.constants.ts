...
export const PRODUCT_DISCOUNT_HEADERS: TableDataHeader[] = [
  ...
  new TableDataHeader('salesChannel.nameRu', 'Administration.Placeholders.Channel', 'ru', 'salesChannel.nameRu'),
  new TableDataHeader('salesChannel.nameGe', 'Administration.Placeholders.Channel', 'ge', 'salesChannel.nameGe'),
  new TableDataHeader('segment.id', 'Administration.Placeholders.Segment', 'string', 'segment.id'),
