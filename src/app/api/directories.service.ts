...
export class DirectoriesService {
  ...
  public getIdentityCardTypeList(): Observable<DirAbsCode[]> {
  ...
  public getProductsList(): Observable<ProductRes[]> {
    return this.productCategoryService.getAllActive();
  }

  public getInspectionResult(): Observable<Directory[]> {
    return this.dirBusinessInspectionResultService.getList();
  }
  ...
  public getInnStatusDir(): Observable<Dir[]> {
    return this.dirInnStatusService.getList();
  }

  public getInnTypeDir(): Observable<Dir[]> {
    return this.dirInnTypeService.getList();
  }
...
export const DIR_SERVICE_FUNC_NAMES_MASS_SEGMENT: Record<MassSegmentDirectoriesNames, string> = {
  [MassSegmentDirectoriesNames.inspectionResult]: 'getInspectionResult',
  [MassSegmentDirectoriesNames.companyActivityTypes]: 'getActivitiesDir',
  [MassSegmentDirectoriesNames.creditPurpose]: 'getCreditPurposeDir',
  [MassSegmentDirectoriesNames.declineReasons]: 'getManagerDeclineReason',
  [MassSegmentDirectoriesNames.declineReasonsCallCenter]: 'getCallCentreDeclineReason',
  [MassSegmentDirectoriesNames.currencies]: 'getCurrencies',
  // [MassSegmentDirectoriesNames.insuranceCompany]: 'getInsuranceCompanyDir',
  // [MassSegmentDirectoriesNames.insuranceType]: 'getInsuranceTypeDir',
  // [MassSegmentDirectoriesNames.insuranceConditions]: 'getInsuranceConditionDir',
  // [MassSegmentDirectoriesNames.communicationType]: 'getCommunicationTypeDir',
  [MassSegmentDirectoriesNames.countries]: 'getCountries',
  // [MassSegmentDirectoriesNames.regions]: 'getRegionDir',
  // [MassSegmentDirectoriesNames.cities]: 'getCityDir',
  // [MassSegmentDirectoriesNames.employmentActivity]: 'getActivitiesDir',
  // [MassSegmentDirectoriesNames.incomeType]: 'getIncomeTypeList',
  // [MassSegmentDirectoriesNames.ipdlType]: 'getIpdlTypeList',
  // [MassSegmentDirectoriesNames.relationships]: 'getRelationshipsDir',
  // [MassSegmentDirectoriesNames.fatca]: 'getFatcaList',
  // [MassSegmentDirectoriesNames.innAbsenceReason]: 'getAbsecceReasonList',
  // [MassSegmentDirectoriesNames.passportType]: 'getIdentityCardTypeList',
  // [MassSegmentDirectoriesNames.dirDecisionMakerDecisionList]: 'getDecisionMakerDecisionsList',
  [MassSegmentDirectoriesNames.stopListAbsStatusList]: 'getStopListAbsStatusList',
  [MassSegmentDirectoriesNames.dirVerifierDecisionList]: 'getVerifierDecisionsList',
  [MassSegmentDirectoriesNames.dirDecisionMakerDeclineReasonList]: 'getDecisionMakerDeclineReasonList',
  [MassSegmentDirectoriesNames.statusData]: 'getCallStatusList',
  // [MassSegmentDirectoriesNames.militaryDutyDir]: 'getMilitaryDutyDir',
  // [MassSegmentDirectoriesNames.status]: 'getStatusDir',
  [MassSegmentDirectoriesNames.productCategories]: 'getProductsList',
  [MassSegmentDirectoriesNames.gender]: 'getGenderDir',
  [MassSegmentDirectoriesNames.maritalStatuses]: 'getMaritalStatusesDir',
  // [MassSegmentDirectoriesNames.creditPurpose]: 'getCreditPurposeDir',
  // [MassSegmentDirectoriesNames.numberEmployee]: 'getNumberEmployeeDir',
  // [MassSegmentDirectoriesNames.accommodationType]: 'getAccommodationTypeDir',
  // [MassSegmentDirectoriesNames.employmentLegalStructure]: 'getEmploymentLegalStructureType'
  [MassSegmentDirectoriesNames.innStatus]: 'getInnStatusDir',
  [MassSegmentDirectoriesNames.innType]: 'getInnTypeDir'
};
