...
export class DirIncomeTypeControllerService {
  ...
  public getList(): Observable<Dir[]> {
    return this.http.get<Dir[]>(`${this.baseUrl}/dir-income`);
  }
  ...
  public create(data: Dir): Observable<Dir> {
    return this.http.post<Dir>(`${this.baseUrl}/dir-income`, data);
  }
  ...
  public getById(id: number): Observable<Dir> {
    return this.http.get<Dir>(`${this.baseUrl}/dir-income/${id}`);
  }
  ...
  public deactivate(id: number): Observable<ResponseEntity> {
    return this.http.get<ResponseEntity>(`${this.baseUrl}/dir-income/deactivate/${id}`);
  }
  ...
  public download(): Observable<Blob> {
    return this.http.get(`${this.baseUrl}/dir-income/download`, { responseType: 'blob' });
  }
  ...
  public getByPage(param: PaginationAndSortingDto): Observable<PageDTO<Dir>> {
    ...
    return this.http.get<PageDTO<Dir>>(`${this.baseUrl}/dir-income/page`, { params });
  }
  ...
  public update(data: Dir): Observable<Dir> {
    return this.http.post<Dir>(`${this.baseUrl}/dir-income/update`, {
      ...data
    });
  }
  ...
  public upload(options: UploadOptions): Observable<ResponseEntity> {
    ...
    return this.http.post<ResponseEntity>(`${this.baseUrl}/dir-income/upload`, params);
  }
}
