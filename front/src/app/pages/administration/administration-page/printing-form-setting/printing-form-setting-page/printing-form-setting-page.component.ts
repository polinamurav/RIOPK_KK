...
type Options = PrintingForm | ProductDto | DirStage | DirProductGroup;
...
export class PrintingFormSettingPageComponent extends AllowEditDirective implements OnInit, OnDestroy {
