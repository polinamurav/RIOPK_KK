...
import {
  DirAbsAttribute,
  DirAbsAttributeDto,
  EmptyDirAbsAttributeDto
} from '@app/_models/api-models/dir-abs-attribute';
...
export class AttributesPageComponent extends AllowEditDirective implements OnInit, OnDestroy {
  totalCount: number;
