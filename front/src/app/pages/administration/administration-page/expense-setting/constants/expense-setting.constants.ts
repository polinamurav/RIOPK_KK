...
export const EXPENSE_SETTING_HEADERS: TableDataHeader[] = [
  new TableDataHeader(
    'dirExpenseType.nameRu',
    'Administration.TableHeaders.ExpenseSetting.ExpenseType',
    'ru',
    'dirExpenseType.nameRu'
  ),
  new TableDataHeader(
    'dirExpenseType.nameAm',
    'Administration.TableHeaders.ExpenseSetting.ExpenseType',
    'am',
    'dirExpenseType.nameAm'
  ),
  new TableDataHeader(
    'dirExpenseType.nameEn',
    'Administration.TableHeaders.ExpenseSetting.ExpenseType',
    'en',
    'dirExpenseType.nameEn'
  ),
  new TableDataHeader(
    'dirAccountProduct.nameRu',
    'Administration.TableHeaders.ExpenseSetting.AccountProduct',
    'ru',
    'dirAccountProduct.nameRu'
  ),
  new TableDataHeader(
    'dirAccountProduct.nameAm',
    'Administration.TableHeaders.ExpenseSetting.AccountProduct',
    'am',
    'dirAccountProduct.nameAm'
  ),
  new TableDataHeader(
    'dirAccountProduct.nameEn',
    'Administration.TableHeaders.ExpenseSetting.AccountProduct',
    'en',
    'dirAccountProduct.nameEn'
  ),
  ...
  new TableDataHeader(
    'intervalStep',
    'Administration.TableHeaders.ExpenseSetting.IntervalStep',
    'string',
    'intervalStep'
  ),
  new TableDataHeader(
    'oneTimeFeeDate',
    'Administration.TableHeaders.ExpenseSetting.OneTimeFeeDate',
    'date',
    'oneTimeFeeDate'
  ),
