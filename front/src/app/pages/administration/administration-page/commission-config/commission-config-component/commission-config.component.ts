...
import { InsuranceCompany } from '@app/_models';
import { MatDialog } from '@angular/material/dialog';
import { ProductDto } from '@app/_models';
...
type Options = ProductDto | Dir | InsuranceCompany | CustomOptionList;
...
export class CommissionConfigComponent extends AllowEditDirective implements OnInit, OnDestroy {
