...
export class ProductCatalogPageComponent extends AllowEditDirective implements OnInit, OnDestroy {
  totalCount: number;
  ...
  constructor(
    ...
    private conditionControllerService: ConditionControllerService,
  ...
  fileServiceSelect(type: any) {
    if (type === 'downloadExel') {
      const fileName = 'Продуктовый Каталог' + '.xlsx';
      this.conditionControllerService
        .download()
