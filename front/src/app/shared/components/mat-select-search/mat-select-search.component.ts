...
import { MatSelect, SELECT_PANEL_MAX_HEIGHT } from '../mat-select/mat-select';
...
export class MatSelectSearchComponent implements OnInit, OnDestroy, AfterViewInit, ControlValueAccessor {
  ...
  /**
   *  Text that is appended to the currently active item label announced by
   * screen readers, informing the user of the current index, value and total options.
