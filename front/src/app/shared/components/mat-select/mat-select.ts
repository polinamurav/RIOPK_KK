...
const _MatSelectMixinBase: Constructor<CanDisableRipple> &
  Constructor<HasTabIndex> &
  Constructor<CanDisable> &
  AbstractConstructor<CanDisable> &
  Constructor<CanUpdateErrorState> &
