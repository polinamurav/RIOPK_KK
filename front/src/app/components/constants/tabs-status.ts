...
export enum TabsDataNames {
  AcraCreditInfo = 'acraCreditInfo',
  ApplicantLoanObligationsInfo = 'applicantLoanObligationsInfo',
  EmploymentInfo = 'employmentInfo',
  BorrowerInfo = 'borrowerInfo',
  SummaryIndividualsInfo = 'summaryIndividualsInfo',
  ApplicationsAppTheOPZTab = 'applicationsAppTheOPZTab',
  EmployersApplications = 'employersApplications',
  EmployersBlackList = 'employersBlackList',
...
export const INITIAL_TABS_STATE: TabsStatesList<TabsDataNames, RetailDirectoriesNames> = {
  ...
  [TabNames.FinalDecision]: {
    ...
    tabDirectoriesNamesList: [
      ...
      // RetailDirectoriesNames.insuranceProduct   // todo: fix
    ]
  },
  [TabNames.Aml]: {
    isVisible: false,
  ...
  [TabNames.DecisionMaking]: {
    ...
    tabDirectoriesNamesList: [
      ...
      RetailDirectoriesNames.typeOfDecisions, // todo: fix 500 from api
      RetailDirectoriesNames.decisions,
  ...
  [TabNames.FullForm]: {
    ...
    isReadonly: true,
    tabDataNamesList: [
      TabsDataNames.AcraCreditInfo,
      TabsDataNames.ApplicantLoanObligationsInfo,
      TabsDataNames.ApplicantIncomeInfoDM,
  ...
  [TabNames.Employment]: {
    isVisible: true,
    isReadonly: true,
    tabDataNamesList: [TabsDataNames.EmploymentInfo]
  },
  ...
  [TabNames.Borrower]: {
    ...
    isReadonly: true,
    tabDataNamesList: [
      TabsDataNames.BorrowerInfo,
      TabsDataNames.EmployersApplications,
      TabsDataNames.EmployersBlackList,
      TabsDataNames.ApplicationsAppTheOPZTab
    ], // TabsDataNames.BorrowerInfo
    tabDirectoriesNamesList: [] // TODO add necessary guides
  },
  [TabNames.AcbInfo]: {
    isVisible: true,
    isReadonly: true,
  ...
  [TabNames.InternalInfo]: {
    isVisible: true,
    isReadonly: true,
    tabDataNamesList: [TabsDataNames.SummaryIndividualsInfo]
  },
  [TabNames.Documents]: {
    isVisible: true,
    isReadonly: false,
...
export const TABS_STATE_FOR: TabsStatesListForStage<TabsDataNames, RetailDirectoriesNames> = {
  ...
  [PathForStage.COMPLETED]: COMPLETED_CONFIG,
  [PathForStage.COMPLETED_DECLINE]: COMPLETED_CONFIG
};
