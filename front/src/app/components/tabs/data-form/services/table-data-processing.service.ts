...
export class TableDataProcessingService {
  ...
  public updateIncomeInfo(applicationData: Application): Observable<ApplicantIncomeGetDto[]> {
    return this.applicantIncomeService.getByApplicantIdAndApplicationId(applicationData.id.toString());
  }
  ...
  public updateCreditDetailsInfo(applicationData: Application): Observable<ApplicantLoanFilteredDto> {
    return this.applicantLoanService.getLoanObligationsOfApplicant(applicationData.applicant.applicationId, {
      applicationId: applicationData.applicant.id
    });
  }
  ...
  private createIncomeInfo(applicationData: Application, rowValue: Partial<ApplicantIncomePostDto>) {
    ...
    } as unknown) as ApplicantIncomePostDto;
    return this.applicantIncomeService.create(incomeInfoGet);
  }

  private createLoanInfo(applicationData: Application, rowValue: Partial<ApplicantLoanDto>, groupName: string) {
    // const loanInfo = {
    //   ...rowValue,
