import { BaseFormField, EditableTableHeader, EInputType, OptionListNames, TableDataHeader } from '@app/_models';
...
export const FINAL_MATRIX_HEADERS: TableDataHeader[] = [
  ...
  new TableDataHeader('product.nameAm', 'Verification.TableHeaders.Product', 'am'),
