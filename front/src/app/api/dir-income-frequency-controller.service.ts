...
export class DirIncomeFrequencyControllerService {
  ...
  public getList(): Observable<Dir[]> {
    return this.http.get<Dir[]>(`${this.baseUrl}/dir-income-frequency`);
  }
  ...
  public getByPage(param: PaginationAndSortingDto): Observable<PageDTO<Dir>> {
    ...
    return this.http.get<PageDTO<Dir>>(`${this.baseUrl}/dir-income-frequency/page`, {
      params
    });
  }
  ...
  public download(): Observable<Blob> {
    return this.http.get(`${this.baseUrl}/dir-income-frequency/download`, { responseType: 'blob' });
  }
  ...
  public upload(options: UploadOptions): Observable<ResponseEntity> {
    ...
    return this.http.post<ResponseEntity>(`${this.baseUrl}/dir-income-frequency/upload`, params);
  }
}
