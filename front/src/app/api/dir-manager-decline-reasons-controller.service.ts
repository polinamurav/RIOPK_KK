...
export class DirManagerDeclineReasonsControllerService {
  ...
  public getList(): Observable<Directory[]> {
    return this.http.get<Directory[]>(`${this.baseUrl}/manager-decline-reasons`);
  }
  ...
  public getByPage(param: PaginationAndSortingDto): Observable<PageDTO<Directory>> {
    ...
    return this.http.get<PageDTO<Directory>>(`${this.baseUrl}/manager-decline-reasons/page`, { params });
  }
  ...
  public download(): Observable<Blob> {
    return this.http.get(`${this.baseUrl}/manager-decline-reasons/download`, { responseType: 'blob' });
  }
  ...
  public upload(options: UploadOptions): Observable<ResponseEntity> {
    ...
    return this.http.post<ResponseEntity>(`${this.baseUrl}/manager-decline-reasons/upload`, params);
  }
}
