...
export class ApplicantIncomeControllerService {
   ...
   */
  public getByApplicantIdAndApplicationId(application_id: string): Observable<ApplicantIncomeGetDto[]> {
    return this.http.get<ApplicantIncomeGetDto[]>(this.baseUrl + `/applicant-income/${application_id}`);
  }
   ...
   * @returns Observable<ApplicantIncomeGetDto>
   */
  public create(applicantIncome: ApplicantIncomePostDto): Observable<ApplicantIncomePostDto> {
    return this.http.post<ApplicantIncomePostDto>(this.baseUrl + `/applicant-income/create`, applicantIncome);
  }
