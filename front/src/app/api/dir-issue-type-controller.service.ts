...
export class DirIssueTypeControllerService {
  ...
  public getList(): Observable<Dir[]> {
    return this.http.get<Dir[]>(`${this.baseUrl}/dir-issue-type`);
  }
  ...
  public getByPage(param: PaginationAndSortingDto): Observable<PageDTO<Dir>> {
    ...
    return this.http.get<PageDTO<Dir>>(`${this.baseUrl}/dir-issue-type/page`, {
      params
    });
  }
  ...
  public download(): Observable<Blob> {
    return this.http.get(`${this.baseUrl}/dir-issue-type/download`, { responseType: 'blob' });
  }
  ...
  public upload(options: UploadOptions): Observable<ResponseEntity> {
    ...
    return this.http.post<ResponseEntity>(`${this.baseUrl}/dir-issue-type/upload`, params);
  }
}
