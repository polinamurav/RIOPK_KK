...
export class CreditInfoControllerService {
   ...
   */
  public updateCreditInfo(
    data: Partial<CreditInfo | CreditInfoDto>,
    applicationId: number,
    stageId: string
  ): Observable<number> {
    return this.http.post<number>(`${this.baseUrl}/credit-info/chosen/update/${applicationId}/${stageId}`, data);
  }
}
