...
export class DirCurrencyControllerService {
  ...
  public getList(): Observable<Dir[]> {
    return this.http.get<Dir[]>(`${this.baseUrl}/currencies`);
  }
  ...
  public getByPage(param: PaginationAndSortingDto): Observable<PageDTO<Directory>> {
    ...
    return this.http.get<PageDTO<Directory>>(`${this.baseUrl}/currencies/page`, { params });
  }
  ...
  public download(): Observable<Blob> {
    return this.http.get(`${this.baseUrl}/currencies/download`, { responseType: 'blob' });
  }
  ...
  public upload(options: UploadOptions): Observable<ResponseEntity> {
    ...
    return this.http.post<ResponseEntity>(`${this.baseUrl}/currencies/upload`, params);
  }
}
