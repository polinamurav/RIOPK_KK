...
export class DirCreditPurposeControllerService {
  ...
  public getList(): Observable<Directory[]> {
    return this.http.get<Directory[]>(`${this.baseUrl}/credit-purposes`);
  }
  ...
  public getByPage(param: PaginationAndSortingDto): Observable<PageDTO<Directory>> {
    ...
    return this.http.get<PageDTO<Directory>>(`${this.baseUrl}/credit-purposes/page`, { params });
  }
  ...
  public download(): Observable<Blob> {
    return this.http.get(`${this.baseUrl}/credit-purposes/download`, { responseType: 'blob' });
  }
  ...
  public upload(options: UploadOptions): Observable<ResponseEntity> {
    ...
    return this.http.post<ResponseEntity>(`${this.baseUrl}/credit-purposes/upload`, params);
  }
}
