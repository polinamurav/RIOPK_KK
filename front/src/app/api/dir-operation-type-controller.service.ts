...
export class DirOperationTypeControllerService {
  ...
  public getList(): Observable<Dir[]> {
    return this.http.get<Dir[]>(`${this.baseUrl}/operation-type`);
  }
  ...
  public create(data: Dir): Observable<Dir> {
    return this.http.post<Dir>(`${this.baseUrl}/operation-type`, data);
  }
  ...
  public getById(id: number): Observable<Dir> {
    return this.http.get<Dir>(`${this.baseUrl}/operation-type/${id}`);
  }
  ...
  public deactivate(id: number): Observable<ResponseEntity> {
    return this.http.get<ResponseEntity>(`${this.baseUrl}/operation-type/deactivate/${id}`);
  }
  ...
  public download(): Observable<Blob> {
    return this.http.get(`${this.baseUrl}/operation-type/download`, { responseType: 'blob' });
  }
  ...
  public getByPage(param: PaginationAndSortingDto): Observable<PageDTO<Dir>> {
    ...
    return this.http.get<PageDTO<Dir>>(`${this.baseUrl}/operation-type/page`, { params });
  }
  ...
  public update(data: Dir): Observable<Dir> {
    return this.http.post<Dir>(`${this.baseUrl}/operation-type/update`, {
      ...data
    });
  }
  ...
  public upload(options: UploadOptions): Observable<ResponseEntity> {
    ...
    return this.http.post<ResponseEntity>(`${this.baseUrl}/operation-type/upload`, params);
  }
}
