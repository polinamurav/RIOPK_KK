...
export class DirIpdlControllerService {
  private baseUrl = environment.baseUrl;

  constructor(private http: HttpClient) {}

  /**
   * Получение полного списка данных IpdlType
   * @returns Observable of Dir
   */
  public getList(): Observable<Dir[]> {
    return this.http.get<Dir[]>(`${this.baseUrl}/ipdl`);
  }
  ...
  public create(data: Dir): Observable<Dir> {
    return this.http.post<Dir>(`${this.baseUrl}/ipdl`, data);
  }
  ...
  public getById(id: number): Observable<Dir> {
    return this.http.get<Dir>(`${this.baseUrl}/ipdl/${id}`);
  }
  ...
  public deactivate(id: number): Observable<ResponseEntity> {
    return this.http.get<ResponseEntity>(`${this.baseUrl}/ipdl/deactivate/${id}`);
  }
  ...
  public download(): Observable<Blob> {
    return this.http.get(`${this.baseUrl}/ipdl/download`, { responseType: 'blob' });
  }
  ...
  public getByPage(param: PaginationAndSortingDto): Observable<PageDTO<Dir>> {
    ...
    return this.http.get<PageDTO<Dir>>(`${this.baseUrl}/ipdl/page`, { params });
  }
  ...
  public update(data: Dir): Observable<Dir> {
    return this.http.post<Dir>(`${this.baseUrl}/ipdl/update`, {
      ...data
    });
  }
  ...
  public upload(options: UploadOptions): Observable<ResponseEntity> {
    ...
    return this.http.post<ResponseEntity>(`${this.baseUrl}/ipdl/upload`, params);
  }
}
