...
export class DirSalesChannelControllerService {
  ...
  public getList(): Observable<Directory[]> {
    return this.http.get<Directory[]>(`${this.baseUrl}/sales-channels`);
  }
  ...
  public getByPage(param: PaginationAndSortingDto): Observable<PageDTO<Directory>> {
    ...
    return this.http.get<PageDTO<Directory>>(`${this.baseUrl}/sales-channels/page`, { params });
  }
  ...
  public download(): Observable<Blob> {
    return this.http.get(`${this.baseUrl}/sales-channels/download`, { responseType: 'blob' });
  }
  ...
  public upload(options: UploadOptions): Observable<ResponseEntity> {
    ...
    return this.http.post<ResponseEntity>(`${this.baseUrl}/sales-channels/upload`, params);
  }
}
