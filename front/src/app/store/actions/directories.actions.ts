...
export enum DirectoryActions {
  ...
  DirSetFatcaRegions = '[Directories Page], Directories set FatcaRegions',
  DirUploadFatcaRegions = '[Directories Page], Directories upload FatcaRegions',
  DirSetFatcaRegionsSuccess = '[Directories Page], Directories set FatcaRegions success',
...
export const DirSetPaymentCardSuccessAction = createAction(
  ...
  props<{ data: PageDTO<DirIncomeType> }>()
);
...
// FATCA REGIONS
export const DirSetFatcaRegionsAction = createAction(
  DirectoryActions.DirSetFatcaRegions,
  props<{ data: PaginationAndSortingDto }>()
);
export const DirUploadFatcaRegionsAction = createAction(
  DirectoryActions.DirUploadFatcaRegions,
  props<{ sortAndPage: PaginationAndSortingDto; uploadFile: UploadOptions }>()
);
export const DirSetFatcaRegionsSuccessAction = createAction(
  DirectoryActions.DirSetFatcaRegionsSuccess,
  props<{ data: PageDTO<Dir> }>()
);
