...
export class DirectoriesEffects {
  ...
  getBankBranch$ = createEffect(() => {
    return this.actions$.pipe(
      ...
      switchMap(({ data }) => {
        return this.branchService.getList();
      }),
      switchMap(data => {
  ...
  getDirFatcaRegion$ = createEffect(() => {
    return this.actions$.pipe(
      ofType(DirectoriesActions.DirSetFatcaRegionsAction),
      switchMap(({ data }) => {
        return this.dirFatcaRegionHttpService.getByPage(data);
      }),
      switchMap(data => {
        return of(DirectoriesActions.DirSetFatcaRegionsSuccessAction({ data }));
      })
    );
  });
