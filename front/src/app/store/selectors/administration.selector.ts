...
export const selectPreApproved = createSelector(
  selectAdministration,
  (state: AdministrationState) => state.preApprovedOffer
);
...
export const levelsPm = createSelector(
  selectAdministration,
  (state: AdministrationState) => state.levelsPm
);

export const productTemplates = createSelector(
  selectAdministration,
  (state: AdministrationState) => state.productTemplates
);
