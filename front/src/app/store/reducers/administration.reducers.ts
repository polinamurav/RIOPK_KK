...
export const administrationReducer = createReducer(
  ...
  on(AdministrationActions.AdmLevelsPMSuccessAction, (state, { data }) => {
    const copyState = cloneDeep(state);
    copyState.levelsPm = data;
    return copyState;
  }),
  on(AdministrationActions.ProductTemplateSuccessAction, (state, { data }) => {
    const copyState = cloneDeep(state);
    copyState.productTemplates = data;
    return copyState;
  }),
  ...
  on(AdministrationActions.AdmSetPreapprovedOfferSuccessAction, (state, { data }) => {
    const copyState = cloneDeep(state);
    copyState.preApprovedOffer = data;
    return copyState;
  }),
